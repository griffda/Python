...
for varName, range in get_nth_key(bin_edges_dict, ):
...
# for i in range(len(bin_edges_dict.values()-1)):
...
# for varName, range in bin_edges_dict.items():
...
#     print(bin_edges[:])
    ...
    #plot the priors
    # plt.bar(xticksv, posteriors.values(), align='center', width=binwidths, color='black', alpha=0.2, linewidth=0.2)
