...
for name in y_train:
    name_bins = name + '_bins'
    # y_train[name_bins], bin_edges = pd.qcut(y_train[name], 8, labels=labels2, retbins=True)
    y_train[name_bins], bin_edges = pd.cut(y_train[name], 8, labels=labels2, retbins=True)
    bin_edges_dict[name_bins]=bin_edges
...
for name in y_test:
    name_bins = name + '_bins'
    y_test[name_bins], bin_edges = pd.qcut(y_test[name], 4, labels=labels, retbins=True)
    bin_edges_dict[name_bins]=bin_edges
