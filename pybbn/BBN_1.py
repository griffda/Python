...
m = BbnNode(Variable(0, 'm', ['1'] ), probs(df, child='m'))
vf = BbnNode(Variable(1, 'vf', ['1']), probs(df, child='vf', parent1='m'))
KE = BbnNode(Variable(2, 'KE', ['1']), probs(df, child='KE', parent1='vf'))
