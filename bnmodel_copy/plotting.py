...
class Plotter:
    def plot_errors(self, norm_distance_errors, histnbins, prediction_accuracy, av_prediction_accuracy, axperrow=3):
        """
        ...
        histnbins : int, number of bins for the histogram
        prediction_accuracy : list of floats, prediction accuracy for each fold
        av_prediction_accuracy : float, average prediction accuracy
    ...
    def plot_results(self, posteriors, edges, priors, inputs, outputs, obs2plot: int, axperrow: int = 3):
        """
