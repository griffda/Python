...
import numpy as np
#from bos_sampling_suraj_edit import ball_on_slope
from bos_sampling_suraj_edit import create_output_dataframe
...
### VECTORIZATION
#vbos = np.vectorize(ball_on_slope(sample_array))

###FUNCTIONS 
create_output_dataframe(ball, ball_v, ball_a, k_e)
