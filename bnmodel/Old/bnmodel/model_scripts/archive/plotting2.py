...
###This function is for the plotting of the posterior probabilities.
###It will stack subplots of the posterior probabilities on top of each other for each obsersvation. 
###The number of subplots will be equal to the number of observations.
...
def create_all_subplots(fig, n_rows, n_cols, bin_edges_dict, priors_dict, obs_posteriors):
    """
    Create a stacked figure with each row representing a different subset of plots.
    """
